                ...
                <div class="dashboard_content_up_item">
                    ...
                    <div class="dashboard_content_up_item_percent">
                        <div class="dashboard_content_up_item_percent_content">
                            <p>{{ count($user->competetions->where("is_done", 1)) }}/{{ count($user->competetions) }}</p>
                        </div>
                    </div>
                ...
                <div class="dashboard_content_up_item">
                    ...
                    <div class="dashboard_content_up_item_percent">
                        <div class="dashboard_content_up_item_percent_content">
                            ...
                            <?php $user_test_count = count($user->competetions->where("is_done", 1));
                            ?>
                
                            <p>{{  floor( $user_test_count) * 100  / count($user->competetions) }}%</p>
                            @else
                            <p>0%</p>
                            @endif
                        </div>
...
<path d="M19.6172 68.7495L44.4307 26.0781H94.0578L118.871 68.7495L94.0578 111.421H44.4307L19.6172 68.7495Z" fill="white" stroke="#FFB4B4"/>
