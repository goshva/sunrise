...
<div class="position-content_sector-wrap" id="sector{{  $position->id }}">
    <div class="position-content_section"  id="position-content_section{{$position->id}}">
        ...
        <div class="">
            <div class="position-content_sector-svg" >
                <p class="position-content_sector-p">Индикаторы111</p>
...
<div class="position-content_sector-wrap" id="sector{{  $position->id }}">
        ...
        <div class="position-content_sector-svg" >
            ...
            </div> <div class="position-content_sector-svg">
    ...
    <!--таблица-->
    <div class="position-content_section" id="position-content_section{{$position->id}}" style="display: flex;flex-direction:column;">
