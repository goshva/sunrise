            ...
            <div class="repost-content_grid">
                <div class="repost-content_flex">
                 <span class="repost-content_flex-grid">
                      ...
                      <p class="repost-content_flex-info">Отчет об обучении {{ $user_repost->user->last_name }} {{ mb_substr($user_repost->user->first_name,0,1) }}.{{ mb_substr($user_repost->user->fathers_name,0,1) }}</p>
                 </span>
