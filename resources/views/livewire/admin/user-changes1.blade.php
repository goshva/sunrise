                    ...
                    <div class="newrepost-content_section-last_sector-bar" style="width: 100%">
                        ...
                        style="@if($competetion_level < 2)
                            ...
                            @if( $competetion_level < $competetion->competetion->levels->where("position_id",$user->position_id)->first()->level && $competetion_level < 2)
                                ...
                                <path d="M7.16581 24.5885L15.8771 9.5L33.2998 9.5L42.0111 24.5885L33.2998 39.6769L15.8771 39.6769L7.16581 24.5885Z" fill="white" stroke="#FFB4B4"/>
                            ...
                            @elseif( $competetion_level == $competetion->competetion->levels->where("position_id",$user->position_id)->first()->level)
                             <div class="recomended_text">
                                <svg style="right:-20px;" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.16581 24.8538L15.8771 9.76538L33.2998 9.76538L42.0111 24.8538L33.2998 39.9423L15.8771 39.9423L7.16581 24.8538Z" fill="white" stroke="#C5E0BF"/>
                                <path d="M30.3327 21L22.9993 28.3333L19.666 25" stroke="#C5E0BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <div class="recomended_text_content">
                                    <span>{{$competetion->text}}</span>
                                </div>
                             ...
                             @elseif( $competetion_level > $competetion->competetion->levels->where("position_id",$user->position_id)->first()->level )
                               <div class="recomended_text">
                                <svg style="right:-20px;" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.16581 24.5885L15.8771 9.5L33.2998 9.5L42.0111 24.5885L33.2998 39.6769L15.8771 39.6769L7.16581 24.5885Z" fill="white" stroke="#C5E0BF"/>
                                <path d="M25 17L26.7961 22.5279H32.6085L27.9062 25.9443L29.7023 31.4721L25 28.0557L20.2977 31.4721L22.0938 25.9443L17.3915 22.5279H23.2039L25 17Z" fill="#C5E0BF"/>
                            </svg>
                                <div class="recomended_text_content">
                                    <span>{{$competetion->text}}</span>
                                </div>
        ...
        " class="user-popup_content edit_user_popup_content" method="POST" action="{{ route("admin.edit-user") }}">
                ...
                <div class="user-popup_sectors">
                    <div class="user-popup-sector">
                        ...
                        <label class="user-popup_label">Фамилия</label>
                        <input class="user-popup_input" value="{{ $this->editUser->last_name ?? '' }}" name='user_last_name' id="user_last_name" type="text">
                        <label class="user-popup_label">Имя</label>
                        <input  class="user-popup_input" value="{{ $this->editUser->first_name ?? ''}}" name='user_first_name' id="user_first_name" type="text">
                        <label class="user-popup_label">Отчество</label>
                        <input  class="user-popup_input" value="{{ $this->editUser->fathers_name ?? ''}}"  name='user_fathers_name' id="user_fathers_name" type="text">
                        <label class="user-popup_label">Город</label>
