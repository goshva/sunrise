...
class PositionSecondSheetImport implements ToCollection
{
            ...
            */
            if( $collection[$i][0] != null){
              ...
              //dd($this->competetionId);
               ...
               $competetion_level = CompetetionLevel::where("competetion_id",$competetion->id)->where("position_id",$position->id)->where("level", ((int) $collection[$i][$a]))->first();
